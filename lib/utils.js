...
export const AGE_SLAB = {
  AGE_8_12: "8-12",
  AGE_13_16: "13-16",
  AGE_17_22: "17-22",
}

export const AGE_SLAB_LABEL = {
  [AGE_SLAB.AGE_8_12]: "Age 8-12 years",
  [AGE_SLAB.AGE_13_16]: "Age 13-16 years",
  [AGE_SLAB.AGE_17_22]: "Age 17-22 years",
}

export function getAgeSlabFromAge(age) {
  const normalizedAge = parseInt(age)

  if (normalizedAge >= 8 && normalizedAge <= 12) {
    return AGE_SLAB.AGE_8_12
  }

  if (normalizedAge >= 13 && normalizedAge <= 16) {
    return AGE_SLAB.AGE_13_16
  }

  if (normalizedAge >= 17 && normalizedAge <= 22) {
    return AGE_SLAB.AGE_17_22
  }
